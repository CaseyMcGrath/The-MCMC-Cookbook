...
We will start with [The Wave problem](../toy_problems.md#the-wave).  We will copy/paste all of the same code we used before for [The Gaussian Bump problem](../mcmc_1/mcmc_1.md#3d-gaussian-bump), but [modify it appropriately](../cyclic_parameters.md) to handle the model's cyclic parameter!
