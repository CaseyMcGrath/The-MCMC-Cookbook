...
$$
\frac{\text{pr}\left(\vec{x}_{i+1}|\vec{d}\right)}{\text{pr}\left(\vec{x}_{i}|\vec{d}\right)} \ \frac{\text{like}\left(\vec{d}|\vec{x}_{i+1}\right)}{\text{like}\left(\vec{d}|\vec{x}_{i}\right)} \ \frac{\text{jump}\left(\vec{x}_{i}|\vec{x}_{i+1}\right)}{\text{jump}\left(\vec{x}_{i+1}|\vec{x}_{i}\right)} \ > \ \mathcal{U}\left[0,1\right] ,
